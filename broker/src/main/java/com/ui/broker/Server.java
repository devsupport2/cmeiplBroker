...
import com.ui.BrokerConstants;
import com.ui.broker.config.*;
import com.ui.interception.InterceptHandler;
import com.ui.persistence.H2Builder;
import com.ui.persistence.MemorySubscriptionsRepository;
import com.ui.interception.BrokerInterceptor;
import com.ui.broker.security.*;
...
import com.ui.broker.security.IAuthorizatorPolicy;
...
import static com.ui.logging.LoggingUtils.getInterceptorIds;

public class Server {

    private static final Logger LOG = LoggerFactory.getLogger(com.ui.broker.Server.class);
    ...
    private void initInterceptors(IConfig props, List<? extends InterceptHandler> embeddedObservers) {
        ...
        if (interceptorClassName != null && !interceptorClassName.isEmpty()) {
            InterceptHandler handler = loadClass(interceptorClassName, InterceptHandler.class,
                                                 com.ui.broker.Server.class, this);
            if (handler != null) {
